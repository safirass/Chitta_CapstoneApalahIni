  ...
  return (
    <Container>
      <View style={styles.center}>
        <Image
          source={{
            uri: "https://cdn-icons-png.flaticon.com/512/5651/5651858.png",
          }}
          style={{ width: 120, height: 120, marginBottom: 20 }}
        />
        <Text style={styles.title}>Fitur Sedang Dalam Pengembangan</Text>
        <Text style={styles.desc}>
          Kami sedang mempersiapkan fitur musik agar dapat digunakan.
        </Text>
      </View>
    </Container>
  );
